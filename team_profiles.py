...
def get_initial_team() -> List[TeamMember]:
    ...
    members = [
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2410605",  # example: "2024-10789"
            full_name="Rizelyn Joy C. Borbe", # example: "Angelo Reyes"
            role="QA & Feature Engineer",
            specialization="Testing Diagnostics, Theme Engine & Controls",
            github_handle="@rejiyin",          # example: "@areyes-cspc"
            avatar_icon=ft.Icons.BUG_REPORT,
            accent_color=ft.Colors.INDIGO_700,
            photo_url="https://github.com/rejiyin.png",                 # Photo: local asset or URL (e.g. "https://github.com/dev3-github.png")
        ),
    ]
    return members
